                  ...
                  , uint8 alarmMinutes, uint8 alarmSeconds, uint8 repeatMode )
{
  ...
  uint8 set_alarm[6] = {RTC_M41T62_ALARM_MONTH, (0x80 | alarmMonth) , rpt4 + rpt5 + ( 0x3F & alarmDate ) , rpt3 + ( 0x3F & alarmHour )  , rpt2 + ( 0x7F & alarmMinutes ) , rpt1 + ( 0x7F & alarmSeconds )};
